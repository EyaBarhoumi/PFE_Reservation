...
// datatable columns
const cols = [
    {label: 'Reservation Number',fieldName: 'Reservation_Number__c'}, 
    {label: 'Start Date',fieldName: 'Reservation_Begin__c'},
    {label: 'End Date',fieldName: 'Reservation_End__c'}, 
...
export default class ExportData extends LightningElement {
    ...
    // once component is created it will fetch the Reservations
    constructor() {
        super();
    ...
    getReservations() {
        ...
        .catch(error => {
            ...
            this.dispatchEvent(
                new ShowToastEvent({
                    title: 'Error while getting Reservations', 
