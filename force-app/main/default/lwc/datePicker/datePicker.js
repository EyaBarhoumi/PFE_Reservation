...
export default class DatePicker extends NavigationMixin(LightningElement)  {
    ...
    handleInput(event){
        ...
        if(!date) {
            this.errorMessage = "Your input is not valid or does not match the allowed format dd/MM/yyyy.";
            this.hasError = true;
        }
        else{
            this.hasError = false;
